...
export const variantMaker= {
  ...
  updateTetradicMode(tetradicMode){
    variantMaker._swatchRecipeMap.set('tetradicB', this._tetradicSwitchObject[tetradicMode]['tetradicB'])
    variantMaker._swatchRecipeMap.set('tetradicC', this._tetradicSwitchObject[tetradicMode]['tetradicC'])
  },
