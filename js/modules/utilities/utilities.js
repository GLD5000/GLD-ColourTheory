...
export const throttleDebounce = {
  ...
  debounce(callbackFunction, delayTime = 1000) {
    //My own version
    let timerA;
    let counter = 0;
    return (...args) => {
...
export function callLoggerMaker(
  location = "unknown location",
  counter = 0,
  inc = 1
) {
  //pass through outer variable to inner
...
export function callLogger(location = "unknown location") {
  //pass through outer variable to inner
...
function fixedCounterMaker(counter, inc) {
  //pass through outer variable to inner
...
function variableCounterMaker(counter) {
  //pass through outer variable to inner
